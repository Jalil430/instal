        ...
        try:
            ...
            def create_wallet_and_balance(session, sanitized_data):
                ...
                INSERT INTO wallet_balances (
                  ...
                  total_allocated_minor_units, due_to_get_minor_units, expected_revenue_minor_units, paid_amount_minor_units, spent_on_products_minor_units
                ) 
                VALUES (
                  $wallet_id, $user_id, $balance_minor_units, $version, $updated_at,
                  CAST(0 AS Int64), CAST(0 AS Int64), CAST(0 AS Int64), CAST(0 AS Int64), CAST(0 AS Int64)
                );
                """
