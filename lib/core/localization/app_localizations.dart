...
class AppLocalizations {
  ...
  String get statusActive =>
      locale.languageCode == 'ru' ? 'Активный' : 'Active';
  String get statusArchived =>
      locale.languageCode == 'ru' ? 'Архивный' : 'Archived';
  ...
  String get notSpecified =>
      locale.languageCode == 'ru' ? 'Не указан' : 'Not specified';
  String get empty => locale.languageCode == 'ru' ? 'Пусто' : 'Empty';
  String get leaveEmptyToAuto =>
  ...
  String get analytics =>
      locale.languageCode == 'ru' ? 'Аналитика' : 'Analytics';

  // ===== Plurals =====
  String get wallet_one => locale.languageCode == 'ru' ? 'кошелек' : 'wallet';
  String get wallet_few => locale.languageCode == 'ru' ? 'кошелька' : 'wallets';
  ...
  String get client_many =>
      locale.languageCode == 'ru' ? 'клиентов' : 'clients';
  ...
  String get showActive =>
      locale.languageCode == 'ru' ? 'Показать активные' : 'Show Active';
  String get showArchived =>
      locale.languageCode == 'ru' ? 'Показать архив' : 'Show Archived';
  String get archived => locale.languageCode == 'ru' ? 'В архиве' : 'Archived';
  String get unarchived =>
      locale.languageCode == 'ru' ? 'Разархивировано' : 'Unarchived';
  ...
  String get contactNumber => locale.languageCode == 'ru' ? 'Телефон' : 'Phone';
  String get passportNumber =>
      locale.languageCode == 'ru' ? 'Номер паспорта' : 'Passport Number';
  String get address => locale.languageCode == 'ru' ? 'Адрес' : 'Address';
  // Guarantor fields
  String get gurantor =>
      locale.languageCode == 'ru' ? 'Поручитель' : 'Gurantor';
  String get guarantorFullName =>
      locale.languageCode == 'ru' ? 'ФИО поручителя' : 'Guarantor Full Name';
  String get guarantorContactNumber =>
      locale.languageCode == 'ru' ? 'Телефон поручителя' : 'Guarantor Phone';
  String get guarantorPassportNumber =>
      locale.languageCode == 'ru' ? 'Паспорт поручителя' : 'Guarantor Passport';
  String get guarantorAddress =>
      locale.languageCode == 'ru' ? 'Адрес поручителя' : 'Guarantor Address';
  ...
  String get thisYear => locale.languageCode == 'ru' ? 'Этот год' : 'This year';
  ...
  String get installmentCreatedSuccess =>
      locale.languageCode == 'ru'
  ...
  String get noInvestorsAvailable =>
      locale.languageCode == 'ru'
          ? 'Нет доступных инвесторов'
          : 'No investors available';

  String get userShareHelperText =>
      locale.languageCode == 'ru'
  ...
  // ===== Sort Options =====
  String get sortBy =>
      locale.languageCode == 'ru' ? 'Сортировать по' : 'Sort by';
  String get creationDate =>
      locale.languageCode == 'ru' ? 'Дата создания' : 'Creation Date';
  String get sortByName => locale.languageCode == 'ru' ? 'Имени' : 'Name';
  ...
  String get clientPassportAlreadyExists =>
      locale.languageCode == 'ru'
  ...
  String get enterValidDownPayment =>
      locale.languageCode == 'ru'
  ...
  String get validateMonthlyPayment =>
      locale.languageCode == 'ru'
  ...
  String get errorCreatingInstallment =>
      locale.languageCode == 'ru'
  ...
  String deleteInvestorConfirmation(String name) =>
      locale.languageCode == 'ru'
  ...
  String get deleteInvestorsConfirmation =>
      locale.languageCode == 'ru'
          ? 'Вы уверены, что хотите удалить этих инвесторов?'
          : 'Are you sure you want to delete these investors?';
  String investorDeleteError(Object e) =>
      locale.languageCode == 'ru'
          ? 'Ошибка удаления инвестора: $e'
          : 'Error deleting investor: $e';
  String get investorNotFound =>
      locale.languageCode == 'ru' ? 'Кошелек не найден' : 'Wallet not found';
  String get investorUpdatedSuccess =>
      locale.languageCode == 'ru'
          ? 'Инвестор успешно обновлен'
          : 'Investor updated successfully';
  String get investorCreatedSuccess =>
      locale.languageCode == 'ru'
  ...
  String get datesHeader =>
      locale.languageCode == 'ru' ? 'Сроки и даты' : 'Dates';
  ...
  String get allWallets =>
      locale.languageCode == 'ru' ? 'Все кошельки' : 'All wallets';
  String get walletAnalyticsLoadError =>
      locale.languageCode == 'ru'
          ? 'Не удалось загрузить аналитику по кошельку'
          : 'Failed to load wallet analytics';
  String get walletDetails =>
      locale.languageCode == 'ru' ? 'Детали кошелька' : 'Wallet Details';
  String get walletTransactions =>
      locale.languageCode == 'ru' ? 'Операции кошелька' : 'Wallet Transactions';
  String get withoutWallet =>
      locale.languageCode == 'ru' ? 'Без кошелька' : 'Without wallet';
  String get selectWallet =>
      locale.languageCode == 'ru' ? 'Выберите кошелек' : 'Select wallet';
  String get createWallet =>
      locale.languageCode == 'ru' ? 'Создать кошелек' : 'Create wallet';
  String get walletName =>
      locale.languageCode == 'ru' ? 'Название кошелька' : 'Wallet name';
  String get enterWalletName =>
      locale.languageCode == 'ru'
          ? 'Введите название кошелька'
          : 'Enter wallet name';
  String get walletType =>
      locale.languageCode == 'ru' ? 'Тип кошелька' : 'Wallet type';
  String get personal => locale.languageCode == 'ru' ? 'Личный' : 'Personal';
  String get personalWallet =>
      locale.languageCode == 'ru' ? 'Личный кошелек' : 'Personal wallet';
  String get investorWallet =>
      locale.languageCode == 'ru'
          ? 'Инвестиционный кошелек'
          : 'Investor wallet';
  String get investorWalletType =>
      locale.languageCode == 'ru' ? 'Инвестор' : 'Investor';
  String get walletBalance =>
      locale.languageCode == 'ru' ? 'Баланс кошелька' : 'Wallet balance';
  ...
  String get walletInfo =>
      locale.languageCode == 'ru' ? 'Информация о кошельке' : 'Wallet Info';
  String get investmentReturnDate =>
      locale.languageCode == 'ru'
          ? 'Дата возврата инвестиции'
          : 'Investment Return Date';
  String get investorPercentage =>
      locale.languageCode == 'ru' ? 'Процент инвестора' : 'Investor Percentage';
  String get userPercentage =>
      locale.languageCode == 'ru' ? 'Процент пользователя' : 'User Percentage';
  String get yourPercentage =>
      locale.languageCode == 'ru' ? 'Ваш процент' : 'Your Percentage';
  String get totalBalance =>
      locale.languageCode == 'ru' ? 'Общий баланс' : 'Total balance';

  // Wallet descriptions
  String get personalWalletDescription =>
      locale.languageCode == 'ru'
          ? 'Для ваших личных средств'
          : 'For your personal funds';
  String get investorWalletDescription =>
      locale.languageCode == 'ru'
          ? 'Для инвестиций с доходом'
          : 'For investments with income';

  // Wallet form labels
  String get creating =>
      locale.languageCode == 'ru' ? 'Создание...' : 'Creating...';
  String get create => locale.languageCode == 'ru' ? 'Создать' : 'Create';
  String get enterName =>
      locale.languageCode == 'ru' ? 'Введите название' : 'Enter name';

  // Wallet validation messages
  String get investmentAmountRequired =>
      locale.languageCode == 'ru'
          ? 'Сумма инвестиции обязательна'
  ...
  String get percentageSum100 =>
      locale.languageCode == 'ru'
          ? 'Сумма должна быть 100%'
          : 'Sum must be 100%';

  String get expectedReturns =>
      locale.languageCode == 'ru' ? 'Ожидаемые доходы' : 'Expected returns';
  ...
  String get returnDueDate =>
      locale.languageCode == 'ru' ? 'Дата возврата' : 'Return due date';
  ...
  String get deleteInstallmentConfirmation =>
      locale.languageCode == 'ru'
  ...
  String get languageEnglish =>
      locale.languageCode == 'ru' ? 'English' : 'English';
  ...
  String get editProfile =>
      locale.languageCode == 'ru' ? 'Редактировать профиль' : 'Edit Profile';
  ...
  String get enterEmail =>
      locale.languageCode == 'ru' ? 'Введите email' : 'Enter your email';
  String get emailRequired =>
      locale.languageCode == 'ru' ? 'Email обязателен' : 'Email is required';
  ...
  String get saving =>
      locale.languageCode == 'ru' ? 'Сохранение...' : 'Saving...';
  String get saveChanges =>
      locale.languageCode == 'ru' ? 'Сохранить изменения' : 'Save Changes';

  // ===== Authentication & Registration =====
  String get createAccount =>
      locale.languageCode == 'ru' ? 'Создать аккаунт' : 'Create Account';
  String get signUpToGetStarted =>
      locale.languageCode == 'ru'
          ? 'Зарегистрируйтесь, чтобы начать'
          : 'Sign up to get started';
  String get phoneNumber =>
      locale.languageCode == 'ru' ? 'Номер телефона' : 'Phone Number';
  ...
  String get enterPassword =>
      locale.languageCode == 'ru' ? 'Введите пароль' : 'Enter your password';
  ...
  String get nameRequired =>
      locale.languageCode == 'ru' ? 'Имя обязательно' : 'Name is required';
  ...
  String get loginFailed =>
      locale.languageCode == 'ru' ? 'Ошибка входа' : 'Login failed';
  String get dontHaveAccount =>
      locale.languageCode == 'ru'
          ? 'Нет аккаунта? '
          : "Don't have an account? ";
  String get signUp =>
      locale.languageCode == 'ru' ? 'Зарегистрироваться' : 'Sign Up';
  ...
  String get totalRevenue =>
      locale.languageCode == 'ru' ? 'Общая выручка' : 'Total Revenue';
  String get newInstallments =>
      locale.languageCode == 'ru' ? 'Новые рассрочки' : 'New Installments';
  String get collectionRate =>
      locale.languageCode == 'ru' ? 'Эффективность' : 'Collection Rate';
  String get portfolioGrowth =>
      locale.languageCode == 'ru' ? 'Рост портфеля' : 'Portfolio Growth';
  String get paymentsThisWeek =>
      locale.languageCode == 'ru' ? 'Выручка за 7 дней' : 'Revenue Last 7 Days';
  String get installmentStatus =>
      locale.languageCode == 'ru' ? 'Статус рассрочек' : 'Installment Status';
  ...
  String get vsPreview28days =>
      locale.languageCode == 'ru'
          ? 'с предыдущих 28 дней'
          : 'from previous 28 days';
  String get portfolioDetails =>
      locale.languageCode == 'ru' ? 'Детали портфеля' : 'Portfolio Details';
  String get averageInstallmentValue =>
      locale.languageCode == 'ru' ? 'Средний чек' : 'Average Installment Value';
  String get averageTerm =>
      locale.languageCode == 'ru' ? 'Средний срок' : 'Average Term';
  String get topProduct =>
      locale.languageCode == 'ru' ? 'Самый популярный товар' : 'Top Product';
  String get upcomingRevenue30Days =>
      locale.languageCode == 'ru'
          ? 'Ожидаемые платежи (30 дней)'
  ...
  String get profitNext30Days =>
      locale.languageCode == 'ru'
          ? 'Прибыль за 30 дней'
          : 'Profit Next 30 Days';
  String get profitNext90Days =>
      locale.languageCode == 'ru'
          ? 'Прибыль за 90 дней'
          : 'Profit Next 90 Days';
  String get profitNext365Days =>
      locale.languageCode == 'ru'
          ? 'Прибыль за 12 месяцев'
          : 'Profit Next 12 Months';
  String get profitEarnedToDate =>
      locale.languageCode == 'ru' ? 'Полученная прибыль' : 'Profit Earned';
  String get profitOverdue =>
      locale.languageCode == 'ru' ? 'Просроченная прибыль' : 'Overdue Profit';
  String get totalRemainingProfit =>
      locale.languageCode == 'ru'
          ? 'Оставшаяся прибыль'
  ...
  String get sendWhatsAppReminder =>
      locale.languageCode == 'ru' ? 'Отправить напоминание' : 'Send Reminder';
  String get sendReminderConfirmation =>
      locale.languageCode == 'ru'
  ...
  String get reminderSent =>
      locale.languageCode == 'ru' ? 'Напоминание отправлено' : 'Reminder sent';
  String get reminderSentMultiple =>
      locale.languageCode == 'ru' ? 'Напоминания отправлены' : 'Reminders sent';
  String get partialSuccess =>
      locale.languageCode == 'ru' ? 'Частичный успех' : 'Partial Success';
  String get remindersSentPartial =>
      locale.languageCode == 'ru'
          ? 'Напоминания отправлены частично'
          : 'Reminders sent partially';
  String get failedReminders =>
      locale.languageCode == 'ru'
          ? 'Неудачные напоминания'
          : 'Failed reminders';
  String get unknownError =>
      locale.languageCode == 'ru' ? 'Неизвестная ошибка' : 'Unknown error';
  String get ok => locale.languageCode == 'ru' ? 'OK' : 'OK';
  String get retry => locale.languageCode == 'ru' ? 'Повторить' : 'Retry';
  String get noInstallmentsSelected =>
      locale.languageCode == 'ru'
  ...
  String get whatsAppIntegration =>
      locale.languageCode == 'ru'
          ? 'Интеграция WhatsApp'
          : 'WhatsApp Integration';
  String get whatsAppSetup =>
      locale.languageCode == 'ru' ? 'Настройка WhatsApp' : 'WhatsApp Setup';
  ...
  String get credentials =>
      locale.languageCode == 'ru' ? 'Учетные данные' : 'Credentials';
  String get templates => locale.languageCode == 'ru' ? 'Шаблоны' : 'Templates';
  String get setUpWhatsAppIntegration =>
      locale.languageCode == 'ru'
  ...
  String get changeCredentials =>
      locale.languageCode == 'ru'
          ...
          : 'Change Credentials';
  String get changeTemplates =>
      locale.languageCode == 'ru' ? 'Изменить шаблоны' : 'Change Templates';
  String get messageTemplates =>
      locale.languageCode == 'ru' ? 'Шаблоны сообщений' : 'Message Templates';
  String get customizeMessages =>
      locale.languageCode == 'ru'
  ...
  String get updateCredentials =>
      locale.languageCode == 'ru'
          ...
          : 'Update Credentials';
  String get updateGreenApiCredentials =>
      locale.languageCode == 'ru'
          ? 'Обновите учетные данные Green API'
          : 'Update your Green API credentials';
  String get findCredentialsInfo =>
      locale.languageCode == 'ru'
  ...
  String get instanceId =>
      locale.languageCode == 'ru' ? 'Instance ID' : 'Instance ID';
  String get enterInstanceId =>
      locale.languageCode == 'ru'
  ...
  String get instanceIdNumeric =>
      locale.languageCode == 'ru'
          ? 'Instance ID должен быть числовым'
          : 'Instance ID must be numeric';
  String get apiToken =>
      locale.languageCode == 'ru' ? 'API Token' : 'API Token';
  ...
  String get apiTokenTooShort =>
      locale.languageCode == 'ru'
          ? 'API Token слишком короткий'
          : 'API Token appears to be too short';
  String get testConnection =>
      locale.languageCode == 'ru' ? 'Проверить соединение' : 'Test Connection';
  String get testing =>
      locale.languageCode == 'ru' ? 'Проверка...' : 'Testing...';
  ...
  String get continue_ =>
      locale.languageCode == 'ru' ? 'Продолжить' : 'Continue';
  String get completeSetup =>
      locale.languageCode == 'ru' ? 'Завершить настройку' : 'Complete Setup';
  String get settingUp =>
      locale.languageCode == 'ru' ? 'Настройка...' : 'Setting up...';
  String get back => locale.languageCode == 'ru' ? 'Назад' : 'Back';
  String get whatsAppSetupCompleted =>
      locale.languageCode == 'ru'
  ...
  String get templatesUpdated =>
      locale.languageCode == 'ru'
          ? 'Шаблоны успешно обновлены!'
          : 'Templates updated successfully!';
  String get whatsAppRemindersEnabled =>
      locale.languageCode == 'ru'
          ? 'Напоминания WhatsApp включены'
          : 'WhatsApp reminders enabled';
  String get whatsAppRemindersDisabled =>
      locale.languageCode == 'ru'
  ...
  String get connectionTestRequired =>
      locale.languageCode == 'ru'
  ...
  String get failedToSaveTemplates =>
      locale.languageCode == 'ru'
          ? 'Не удалось сохранить шаблоны'
          : 'Failed to save templates';
  String get failedToSaveCredentials =>
      locale.languageCode == 'ru'
          ? 'Не удалось сохранить учетные данные'
          : 'Failed to save credentials';
  String get errorLoadingWhatsAppSettings =>
      locale.languageCode == 'ru'
  ...
  String get youAreUpToDate =>
      locale.languageCode == 'ru'
          ...
          : "You're up to date!";
  String get newestVersionInstalled =>
      locale.languageCode == 'ru'
          ? 'Установлена самая новая версия приложения.'
  ...
  String get paymentDueDate =>
      locale.languageCode == 'ru' ? 'Дата платежа' : 'Payment due date';
  String get daysUntilDueDate =>
      locale.languageCode == 'ru'
  ...
  String get templateTooLong =>
      locale.languageCode == 'ru'
          ? 'Шаблон должен содержать менее 1000 символов'
          : 'Template must be less than 1000 characters';
  String get invalidVariable =>
      locale.languageCode == 'ru'
          ? 'Недопустимая переменная'
          : 'Invalid variable';
  String get unmatchedBraces =>
      locale.languageCode == 'ru'
          ? 'Несовпадающие скобки в шаблоне'
          : 'Unmatched braces in template';
  String get considerUsingVariables =>
      locale.languageCode == 'ru'
          ? 'Рассмотрите использование переменных для персонализации сообщения'
          : 'Consider using variables to personalize the message';
  String get sevenDaysBefore =>
      locale.languageCode == 'ru' ? 'За 7 дней' : '7 Days Before';
  ...
  String get manualReminder =>
      locale.languageCode == 'ru' ? 'Ручное напоминание' : 'Manual reminder';
  String get sevenDayAdvanceReminder =>
      locale.languageCode == 'ru'
          ? 'Напоминание за 7 дней'
          : '7-day advance reminder';
  String get enterMessageTemplate =>
      locale.languageCode == 'ru'
          ? 'Введите шаблон сообщения здесь...'
          : 'Enter your message template here...';
  String get preview =>
      locale.languageCode == 'ru' ? 'Предварительный просмотр:' : 'Preview:';
  String get templatePreviewPlaceholder =>
      locale.languageCode == 'ru'
          ? 'Предварительный просмотр шаблона появится здесь...'
          : 'Template preview will appear here...';
  String get availableVariables =>
      locale.languageCode == 'ru'
          ? 'Доступные переменные:'
          : 'Available Variables:';
  String get templateIssues =>
      locale.languageCode == 'ru' ? 'Проблемы шаблона:' : 'Template Issues:';
  String get hideVariables =>
      locale.languageCode == 'ru' ? 'Спрятать переменные' : 'Hide Variables';
  String get showVariables =>
      locale.languageCode == 'ru' ? 'Показать переменные' : 'Show Variables';

  // Selection mode
  String get selectAll =>
      locale.languageCode == 'ru' ? 'Выбрать все' : 'Select All';
  String get selectAllOverdue =>
      locale.languageCode == 'ru'
          ? 'Выбрать все просроченные'
          : 'Select All Overdue';
  String get selectionMode =>
      locale.languageCode == 'ru' ? 'Режим выбора' : 'Selection Mode';
  String get selectedItems =>
      locale.languageCode == 'ru' ? 'Выбрано' : 'Selected';
  String get cancelSelection =>
      locale.languageCode == 'ru' ? 'Отменить выбор' : 'Cancel Selection';
  // ===== Subscription System =====
  String get subscriptionWelcomeTitle =>
      locale.languageCode == 'ru'
          ? 'Добро пожаловать в QistPay!'
          : 'Welcome to QistPay!';
  String get subscriptionWelcomeMessage =>
      locale.languageCode == 'ru'
  ...
  String get subscriptionFreeTrialMessage =>
      locale.languageCode == 'ru'
  ...
  String get subscriptionExpiredTitle =>
      locale.languageCode == 'ru' ? 'Подписка истекла' : 'Subscription Expired';
  ...
  String get subscriptionActiveTitle =>
      locale.languageCode == 'ru' ? 'Подписка активна' : 'Subscription Active';
  String get subscriptionActiveMessage =>
      locale.languageCode == 'ru'
          ? 'У вас есть активная подписка. Наслаждайтесь использованием приложения!'
          : 'You have an active subscription. Enjoy using the app!';
  String get subscriptionContactTitle =>
      locale.languageCode == 'ru' ? 'Связаться с нами' : 'Contact Us';
  String subscriptionContactMessage(String telegramHandle) =>
      locale.languageCode == 'ru'
  ...
  String subscriptionContactButton(String telegramHandle) =>
      locale.languageCode == 'ru'
          ? 'Связаться $telegramHandle'
          : 'Contact $telegramHandle';
  String subscriptionTelegramCopied(String telegramHandle) =>
      locale.languageCode == 'ru'
          ? 'Telegram $telegramHandle скопирован в буфер обмена'
          : 'Telegram $telegramHandle copied to clipboard';
  String get subscriptionCodeInputTitle =>
      locale.languageCode == 'ru'
          ? 'Активировать код подписки'
          : 'Activate Subscription Code';
  String get subscriptionCodeInputMessage =>
      locale.languageCode == 'ru'
  ...
  String get subscriptionCodeLabel =>
      locale.languageCode == 'ru' ? 'Код активации' : 'Activation Code';
  String get subscriptionCodeHint =>
      locale.languageCode == 'ru'
          ? 'SUB-2025-001-ABC123'
          : 'SUB-2025-001-ABC123';
  String get subscriptionCodeRequired =>
      locale.languageCode == 'ru'
          ? 'Введите код активации'
          : 'Please enter an activation code';
  String get subscriptionActivateButton =>
      locale.languageCode == 'ru'
          ? 'Активировать подписку'
          : 'Activate Subscription';
  String get subscriptionValidating =>
      locale.languageCode == 'ru' ? 'Проверка кода...' : 'Validating code...';
  String get subscriptionActivatedSuccess =>
      locale.languageCode == 'ru'
          ? 'Подписка успешно активирована!'
          : 'Subscription activated successfully!';
  String get subscriptionUserNotFound =>
      locale.languageCode == 'ru'
          ? 'Пользователь не найден. Попробуйте войти заново.'
          : 'User not found. Please try logging in again.';
  String get subscriptionCheckingStatus =>
      locale.languageCode == 'ru' ? 'Загрузка...' : 'Loading...';
  // Subscription errors
  String get subscriptionErrorUnexpected =>
      locale.languageCode == 'ru'
  ...
  String get subscriptionErrorInvalidCode =>
      locale.languageCode == 'ru'
          ? 'Неверный код активации'
          : 'Invalid activation code';
  String get subscriptionErrorCodeUsed =>
      locale.languageCode == 'ru'
          ? 'Этот код уже был использован'
          : 'This code has already been used';
  String get subscriptionErrorCodeExpired =>
      locale.languageCode == 'ru'
          ? 'Срок действия кода истёк'
          : 'The code has expired';
  String get subscriptionErrorCheckFailed =>
      locale.languageCode == 'ru'
  ...
  String get addMoney =>
      locale.languageCode == 'ru' ? 'Добавить деньги' : 'Add Money';
  String get withdrawMoney =>
      locale.languageCode == 'ru' ? 'Снять деньги' : 'Withdraw Money';
  String get withdraw => locale.languageCode == 'ru' ? 'Снять' : 'Withdraw';
  String get enterAmount =>
      locale.languageCode == 'ru' ? 'Введите сумму' : 'Enter amount';
  String get available =>
      locale.languageCode == 'ru' ? 'Доступно' : 'Available';

  // Wallet list columns and headers
  String get investmentDetailsHeader =>
      locale.languageCode == 'ru'
          ? 'ИНВЕСТИЦИОННЫЕ ДЕТАЛИ'
          : 'INVESTMENT DETAILS';
  String get givenForInstallment =>
      locale.languageCode == 'ru'
          ? 'ВЫДАНО В РАССРОЧКУ'
          : 'GIVEN FOR INSTALLMENT';
  String get dueToGet =>
      locale.languageCode == 'ru' ? 'СКОРО К ПОЛУЧЕНИЮ' : 'DUE TO GET';
  String get income => locale.languageCode == 'ru' ? 'Доход:' : 'Income:';
  String get investment =>
      locale.languageCode == 'ru' ? 'Инвестиция:' : 'Investment:';
  ...
  String get currentBalance =>
      locale.languageCode == 'ru' ? 'Текущий баланс' : 'Current Balance';
  String get givenForInstallmentDetail =>
      locale.languageCode == 'ru'
          ? 'Выдано в рассрочку'
          : 'Given for Installment';
  String get dueToGetDetail =>
      locale.languageCode == 'ru' ? 'Скоро к получению' : 'Due to Get';
  String get totalValue =>
      locale.languageCode == 'ru' ? 'Общая стоимость' : 'Total Value';

  // Wallet transaction history
  String get transactionHistory =>
      locale.languageCode == 'ru' ? 'История операций' : 'Transaction History';
  String get noOperations =>
      locale.languageCode == 'ru' ? 'Нет операций' : 'No operations';
  String get transactions =>
      locale.languageCode == 'ru' ? 'операций' : 'transactions';
  ...
  String get noWallets =>
      locale.languageCode == 'ru' ? 'Нет кошельков' : 'No wallets';
  String get createFirstWalletDescription =>
      locale.languageCode == 'ru'
  ...
  String get noWalletsFound =>
      locale.languageCode == 'ru' ? 'Кошельки не найдены' : 'No wallets found';

  // Wallet form messages
  String get walletUpdatedSuccess =>
      locale.languageCode == 'ru'
  ...
  String get startingAmount =>
      locale.languageCode == 'ru' ? 'Начальная сумма' : 'Starting Amount';
  String get startingAmountRequired =>
      locale.languageCode == 'ru'
          ? 'Начальная сумма обязательна'
          : 'Starting amount is required';

  // Transaction types
  String get transactionTypeInstallment =>
      locale.languageCode == 'ru' ? 'Рассрочка' : 'Installment';
  String get transactionTypeAdjustment =>
      locale.languageCode == 'ru' ? 'Корректировка' : 'Adjustment';
  String get transactionTypeTransfer =>
      locale.languageCode == 'ru' ? 'Перевод' : 'Transfer';
  String get transactionTypeReversal =>
      locale.languageCode == 'ru' ? 'Отмена' : 'Reversal';
  String get transactionTypeInitialInvestment =>
      locale.languageCode == 'ru'
          ? 'Первоначальная инвестиция'
          : 'Initial Investment';
  String get transactionTypeInitialBalance =>
      locale.languageCode == 'ru' ? 'Начальный баланс' : 'Initial Balance';
  String get transactionTypeProfitDistribution =>
      locale.languageCode == 'ru'
          ? 'Распределение прибыли'
          : 'Profit Distribution';

  // Mobile wallet specific
  String get selectedItemsMobile =>
      locale.languageCode == 'ru' ? 'выбрано' : 'selected';

  // Archive wallet
  String get archiveWalletTitle =>
      locale.languageCode == 'ru' ? 'Архивировать кошелек' : 'Archive Wallet';
  String archiveWalletConfirmation(String name) =>
      locale.languageCode == 'ru'
          ? 'Вы уверены, что хотите архивировать кошелек "$name"?'
          : 'Are you sure you want to archive wallet "$name"?';
  String get archive =>
      locale.languageCode == 'ru' ? 'Архивировать' : 'Archive';
  String get unarchiveWalletTitle =>
      locale.languageCode == 'ru'
          ? 'Разархивировать кошелек'
          : 'Unarchive Wallet';
  String unarchiveWalletConfirmation(String name) =>
      locale.languageCode == 'ru'
          ? 'Разархивировать кошелек "$name"?'
          : 'Unarchive wallet "$name"?';
  String get unarchive =>
      locale.languageCode == 'ru' ? 'Разархивировать' : 'Unarchive';
  ...
  String get noClientsFound =>
      locale.languageCode == 'ru' ? 'Клиенты не найдены' : 'No clients found';
}
