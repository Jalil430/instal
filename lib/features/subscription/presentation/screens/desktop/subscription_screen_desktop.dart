...
class SubscriptionScreenDesktop extends StatelessWidget {
  ...
  const SubscriptionScreenDesktop({
    super.key,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Free-trial note (match mobile tint and border)
              Container(
              ...
              // Contact info (match mobile card)
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    Text(
                      l10n.subscriptionContactMessage('@jalil_katalov'),
                      style: Theme.of(context).textTheme.bodySmall,
                    ),
                    const SizedBox(height: 8),
                    Align(
                      ...
                      child: OutlinedButton(
                        onPressed: () {
                          const handle = '@jalil_katalov';
                          Clipboard.setData(const ClipboardData(text: handle));
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(l10n.subscriptionTelegramCopied(handle)),
                              duration: const Duration(seconds: 2),
                            ),
                          );
                        },
                        child: Text(l10n.subscriptionContactButton('@jalil_katalov')),
                      ),
                    ),
                  ],
                ),
