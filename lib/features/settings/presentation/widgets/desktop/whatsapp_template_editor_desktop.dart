...
class WhatsAppTemplateEditorDesktop extends StatefulWidget {
  ...
  const WhatsAppTemplateEditorDesktop({
    super.key,
  ...
  @override
  State<WhatsAppTemplateEditorDesktop> createState() => _WhatsAppTemplateEditorDesktopState();
}

class _WhatsAppTemplateEditorDesktopState extends State<WhatsAppTemplateEditorDesktop> {
