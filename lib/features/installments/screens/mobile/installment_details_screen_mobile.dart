            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoRow(l10n?.installmentStartDate ?? 'Дата начала выплат', dateFormat.format(installment.installmentStartDate)),
                  _buildInfoRow(l10n?.installmentEndDate ?? 'Дата конца выплат', dateFormat.format(installment.installmentEndDate)),
